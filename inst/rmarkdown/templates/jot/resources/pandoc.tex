...
\addtolength{\leftmarginii}{-10pt}
\addtolength{\leftmarginiii}{-10pt}
\renewcommand{\labelitemiii}{$$\circ$$}

%%% ---------------------------

\usepackage[$natbiboptions$]{natbib} % only use natbib, not bibtex or pandoc-citeproc
...
\renewcommand{\maketitle}{%
    ...
    {$if(title-font-size)$$title-font-size$$else$\LARGE$endif$\centerline{\textbf{\@title}}} \\[0.75\baselineskip]
    $if(subtitle)$
      $if(other)$
